...
# ---- compare marginal densities for a focused parameter set ----------------
...
param_labels <- c(
  "mu[1]"  = "mu[TP53]  (gene-level mean)",
  "s[1]"   = "s[TP53]  (gene-level concentration)"
)
...
message("\nposterior summaries (mean, SD, 90% CI):")
print(summ, n = 30)

saveRDS(summ, "results/hmc_vs_advi_summary.rds")
message("\nsaved figs/hmc_vs_advi.png, results/hmc_vs_advi_summary.rds")
